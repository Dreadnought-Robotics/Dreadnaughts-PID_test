...
class pid:
  ...
  def start(self):
    ...
    while not rospy.is_shutdown():
      ...
      self.dolphin=rospy.Subscriber("/rosetta/imu/data",buoy, self.talker)
      ...
      self.PID_yaw = self.getPID(self.kd_yaw, self.ki_yaw, self.kp_yaw, 10, 0, self.pid_i_yaw, self.previous_error_yaw)
      ...
      #YAW
      self.s=dolphins()
      self.s.d1 = int(self.throttle)
      # self.s.d2 = int(self.throttle - self.PID_yaw)
      self.s.d3 = int(self.throttle)
